...
It made the distinctions harder to blur.
...
"This is what the crossed questions might be for."

Not to announce that the world comes in fifty-four boxes.

Not to make every story obey a table.

To test whether several different questions really can cross one another without collapsing into the same thing.
...
That was why crossing the questions was more interesting than merely listing six kinds of change.

The same change might become enough in different ways, and what remained afterward might differ again. If those differences continued to hold up under difficult cases, the map would gain depth.

If they did not, the map—and the number—would have to change.
...
The manager's meeting revealed what she had needed the words to mean in practice.
...
<!--
TECHNICAL SPECIFICATION AND AUTHORING APPENDICES — INVISIBLE TO THE READER
========================================================================

This section is for authorship, diagnosis, classification, and future stress-testing.
It is not reader-facing prose.
It is not sacred.
Its job is to preserve the strongest distinctions the project has earned while preventing later writing from confusing nearby phenomena.

GOVERNING EDITORIAL RULE
------------------------

Preserve the thought. Purify the language.

The visible manuscript should remain a book, not a technical manual.
Experience first.
Recognition second.
Naming last.

The hidden technical specification may be exact where the visible prose should remain ordinary.

PART I — WHAT THE SYSTEM ACTUALLY CLASSIFIES
============================================

1. THE BASIC UNIT IS A LOCAL ACHIEVEMENT OF INTELLIGIBILITY
-----------------------------------------------------------

The 54 do not classify:
...
- domains such as "repair," "mathematics," or "promises";
- everything that happened during an episode.

The unit is smaller and more exact:

A local achievement of intelligibility relative to a live matter at a chosen scale.

Before classifying, ask:

What, exactly, was still unresolved, unavailable, unclear, out of order, uncoordinated, or demanding an answer immediately before this change became enough?

Freeze the matter just before the landing.

Then classify the landing.

This discipline is essential.

The same drawer can participate in several different achievements.
The same conversation can contain several.
The same chapter can contain a sequence of them.
The same physical event can be classified differently if the live question is different.

Do not classify the object.
Do not classify the topic.
Classify what became newly enough at that moment.

2. SCALE MUST BE CHOSEN BEFORE CLASSIFICATION
---------------------------------------------

A larger matter can remain open while a smaller matter within it becomes complete enough.

Examples:

- grief can remain unresolved while one memory becomes more intelligible;
- a historical question can remain open while one date becomes established;
- a disagreement can remain unresolved while the exact point of disagreement becomes clear;
- a proof can remain unfinished while one lemma becomes available;
- a repair can remain incomplete while the fault is correctly identified;
- a journey can remain delayed while the ticket question is settled.

Therefore:

Completion is scale-relative.

"Enough" never means:
nothing more can be said,
nothing can change,
everything is true,
the person feels peaceful,
the whole life-problem is solved.

It means:

At this chosen scale, what was legitimately demanding further resolution has changed enough for continuation.

3. THE LANDING IS NOT THE WHOLE PATH
------------------------------------

Many paths lead to one landing.
...
That does not mean all those forms have collapsed into one category.

They may be successive local achievements.

Likewise, a single scene may contain:
...
If the analysis becomes confused because one episode seems to belong everywhere, split the episode into the smaller achievements that actually occurred.

4. THE LANDING IS NOT ITS LATER USE
-----------------------------------

This distinction must never be lost.

What remains immediately after an achievement is one question.

What role that remainder later plays is another.

A fact may later become a tool.
A relation may later become a habit.
A skill may later become evidence.
A remembered warning may later become the start of a different problem.
A written answer may later be reopened as a question.

The later use does not retroactively change what happened in the first completion.
...
Each local achievement is analysed with three questions.

1. WHAT CHANGED?
2. WHAT MADE THAT CHANGE ENOUGH?
3. WHAT REMAINED IMMEDIATELY AFTERWARD?

These are analytically distinct questions.

Crossing their current answer-sets produces 6 x 3 x 3 = 54 canonical candidate forms.

"Canonical candidate forms" means:
the current system yields 54 coordinate combinations worth testing.

It does not mean:
all 54 occur equally often;
all 54 are equally important;
the lists are proven exhaustive;
every episode has only one possible analysis;
the number is metaphysically sacred.

The three questions are more secure than the exact lists.
The larger inquiry is more secure than the three questions.

A. FIRST COORDINATE — WHAT CHANGED?
-----------------------------------

There are currently six basic transformation patterns.

A1. DIFFERENTIATION
Something previously blurred, conflated, undivided, or insufficiently distinguished becomes distinct enough to matter.

Plain-language test:
Now I can tell which is which, what differs, or where the relevant boundary lies.

Typical examples:
- two similar screws turn out to differ in length;
- physical possibility is distinguished from what an action counts as;
- two interpretations are shown to remain genuinely different;
- a memory is separated from what a video actually establishes;
- a model is distinguished from the range in which it is reliable.
...
Relating answers:
How do these things bear on one another?

A2. OPENING
Something that was not available becomes available as a live possibility, route, move, question, option, or access.

Plain-language test:
Now something can be done, considered, entered, tried, or continued that was not available before.

Typical examples:
- a route becomes available;
- a new move in a proof becomes possible;
- a new way to handle a conflict appears;
- someone gains access to a skill or practice;
- an inherited record makes a forgotten matter available again.

Close neighbour:
Efficacy.

Difference:
Opening is what changed.
Efficacy is a mode of what remains.

A completion may therefore be Opening x Focal x Efficacy:
a new possibility opens because of one decisive thing, and what remains is mainly a new capacity to act.

A3. RELATING
A relation that was absent, obscure, mistaken, or insufficiently grasped becomes clear enough.

Plain-language test:
Now I can see how this goes with that.

Typical examples:
- the violin line is heard as continuing the cello line;
- the leak is connected to the copper joint;
- a promise is understood through how later actions count toward it;
- a map is understood through which relations it preserves;
- a fictional action becomes intelligible in relation to earlier characterization.

Close neighbours:
Differentiation and Integration.

Difference from Differentiation:
Relating is not merely seeing that two things differ; it is seeing how they bear on one another.

Difference from Integration:
Relating can clarify one or more relations without producing one organized whole.
Integration is achieved when several parts become mutually organized enough that the whole itself now functions or can be grasped.

A4. REPAIR
Something failing, mistaken, damaged, disordered, misaligned, or otherwise not functioning as required is brought back into adequate order.

Plain-language test:
Something that was wrong is now put right enough.

Typical examples:
- a drawer works again;
- a failed fixing is restored;
- a mistaken procedure is corrected;
- a broken coordination is made workable again.

Close neighbours:
Relating and Settlement.

Difference:
The fault may need to be related correctly before repair is possible.
The question "what is wrong?" may settle before the thing itself is repaired.
Classify whichever live matter is frozen.

If the live matter is:
What is causing the failure?
the landing may be Relating or Settlement.

If the live matter is:
Can we restore adequate functioning?
the landing may be Repair.

A5. INTEGRATION
Previously separate parts become organized enough to function, be grasped, or be used as one coherent whole.

Plain-language test:
The pieces now work together as one.

Typical examples:
- several specialist contributions become one exhibition;
- musical lines are heard as one phrase;
- parts of a system become coordinated;
- several observations become one organized explanation;
- a recipe, touch, timing, and judgment become one practice.

Close neighbour:
Relating.

Difference:
Relating establishes connections.
Integration yields a whole whose parts now constrain or support one another as a unit.

A6. SETTLEMENT
Something that was still demanding an answer receives one adequate to the live demand.

Plain-language test:
That question now has an answer we can stand on.

Typical examples:
- which platform;
- whose parcel;
- whether the tickets remain valid;
- which date is established;
- what happened in one narrow respect.

Settlement is not "everything is finished."

It is not a universal ending category.

It applies when the unresolved demand itself is primarily answer-shaped:
which?
whether?
who?
what happened?
...
Difference:
Other transformations can cause a question to settle.
Settlement is the transformation when receiving an answer is itself the central change being classified.

B. SECOND COORDINATE — WHAT MADE THAT CHANGE ENOUGH?
-----------------------------------------------------

There are currently three completion topologies.

This coordinate concerns the form of sufficiency, not the content of the transformation.

B1. FOCAL
One decisive locus carries the completion.

Plain-language test:
One thing turns out to decide the matter.

Examples:
- one measurement distinguishes two cases;
- one crack explains the failure;
- one counterexample defeats a universal claim;
- one message identifies the owner;
- one observed movement decides which part is loose.

Important:
Focal does not mean only one thing existed in the situation.
It means one thing became decisive relative to the frozen live matter.

B2. DISTRIBUTED
No single item is sufficient. Several things jointly carry the completion.

Plain-language test:
These things together are enough; no one of them is.

Examples:
- several musical lines make the phrase intelligible;
- look, feel, and sound together make the bread ready;
- several specialists together make the exhibition coherent;
- several passages support an interpretation without one decisive sentence;
- several tests jointly establish confidence.

Distributed does not mean vague.
A distributed completion may be very precise.

B3. RELEASE
The completion occurs because something that had been governing, obstructing, demanding continuation, constraining the options, or holding the matter open loses that claim.

Plain-language test:
Something that had been deciding what had to happen next no longer does.

Examples:
- a feared condition is ruled out and stops controlling the plan;
- an old assumption loses authority;
- a question ceases to press because its premise no longer holds;
- a missed connection stops governing the journey once ticket validity is established;
- an obsolete rule loses its claim to determine present practice.

Critical clarification:

Release is not merely "focal or distributed support with a different name."

A release can be triggered by one thing or by several things.
That trigger structure is not what Release classifies.

Release classifies the form of sufficiency:
the matter becomes enough through discharge, cessation, or loss of governing force rather than through positive establishment alone.

When tempted to call something both Focal and Release, ask:

Am I classifying what triggered the release,
or what made the matter enough?

If the completion consists in an old governor losing its claim, use Release.

C. THIRD COORDINATE — WHAT REMAINED IMMEDIATELY AFTERWARD?
-----------------------------------------------------------

There are currently three persistence modes.

This coordinate concerns the primary form of the immediate remainder.

C1. STANDING
Something is now established enough to be treated as so.

Plain-language test:
There is now something we can say is the case.

Examples:
- this is platform six;
- the shop opened on this date;
- the fuse theory failed;
- these two cases differ;
- this is the relevant fault.

Standing does not mean eternal truth.
A standing result can later be corrected.

C2. BEARING
What remains is primarily relational.

Plain-language test:
What I now have is a grasp of how things stand with respect to one another.

Examples:
- this line continues that line;
- this promise bears on that later action;
- this station connects to that line;
- this feature matters because of its relation to the whole;
- this memory and this record support different parts of the same event.

Bearing is not merely "a fact about a relation."
The relation itself is what does the continuing work.

C3. EFFICACY
What remains is primarily visible in a changed ability, effect, operation, or practical continuation.

Plain-language test:
What I now have shows itself mainly in what can happen next.

Examples:
- the person can now ride;
- the drawer now closes;
- the route can now be followed;
- the team can now coordinate;
- the learner can now continue the proof;
- the rule can now be used.

Critical clarification:

Standing, Bearing, and Efficacy can have secondary consequences in one another.

A standing fact can enable action.
A skill can imply facts.
A relation can become stated.

Classify the primary immediate remainder relative to the frozen live matter.

If two modes appear equally primary, first check whether two successive achievements have been compressed into one.

PART III — THE 54 AS A COORDINATE SPACE
=======================================

The 54 are generated by crossing:

6 transformation patterns
x
3 completion topologies
x
3 persistence modes.

The value of the crossing is not numerology.

It forces three questions that are easy to blur:

- two episodes can involve the same kind of change but become enough differently;
- two episodes can become enough in the same way but leave different remainders;
- the same object can host very different achievements depending on the live question.

The 54 therefore function as a middle-level discriminating map.

They are more specific than:
"something became understandable."

They are less specific than:
the full lived history of an episode.

The right discipline is:

Do not ask:
Which of the 54 is this chapter?

Ask:
Which local landing am I classifying?
What was the live matter?
At what scale?
What changed?
What made that enough?
What remained immediately afterward?

PART IV — WHAT THE 54 DO NOT CLASSIFY
=====================================

Several major concerns of the book sit around the 54 rather than inside it.

1. LATER UPTAKE
---------------

An immediate remainder can later become:
...
This is not a fourth coordinate inside the 54.

It is a relation from one completion-event to a later event.
...
This is how the book's spiral becomes technically compositional.

2. CORRECTION AND REOPENING
---------------------------

A completion can be genuine and later turn out to be wrong, partial, misapplied, or inadequate.

The original completion is not erased.

Instead, later experience can reopen what had become enough.

Reopening may occur through:

- failed prediction;
- counterexample;
- physical resistance;
- another person's correction;
...
Correction therefore belongs to relations among completion-events.

A crucial principle:

What makes understanding fruitful is also what makes it vulnerable.

It reaches beyond the present act.

Because it does, it can be used later.
Because it does, it can be corrected later.

3. SAME-MATTER CONTINUITY
-------------------------

The same-matter problem concerns whether two separated occasions remain answerable to sufficiently the same ongoing matter.

Current heuristic:

Two occasions remain about the same matter when enough continuity remains for what happens in one to answer, contradict, correct, fulfil, prove, explain, or continue what was at issue in the other.
...
- continue that?
- prove that?
- keep or break that undertaking?

Helpful question:

Same for what?

This is not yet a complete theory of identity.

Do not make "enough continuity" circular.
Do not let purpose-relativity make sameness arbitrary.
Do not force a sharp boundary where the cases remain genuinely borderline.

Technically:

same-matter continuity is an edge between completion-events, not one of the coordinates inside either event.

4. COMMUNICATION
----------------

Communication is not simply:
private understanding -> package -> transfer -> identical copy.
...
Another person may then achieve understanding from their own side.

The first person's completion can therefore become:
...
- an invitation;
- a constraint;
- material for another person's completion.

Technically:

communication is one way conditions and remainders become available across points of view.

It is not a fourth axis of the 54.

5. SHARED REALITY
-----------------

Keep the practical definition:

Shared reality is present when different people are connected closely enough to the same ongoing matter that what one notices, says, does, tests, or questions can genuinely change what the others can reasonably think or do next, while the matter remains capable of resisting all of them.

Shared reality does not require:

- identical mental contents;
- agreement;
- equal knowledge;
- simultaneous presence;
- one shared mind.

It can include disagreement and correction.

Successful coordination alone is not sufficient evidence of deep shared understanding.
Chapter 24 demonstrates why.

6. CARRIERS
-----------

A completion is not identical to the thing that carries traces of it.
...
A carrier can remain while understanding is lost.
Understanding can remain while the carrier changes.
Different carriers can support continuation of the same matter.

Do not equate storage with understanding.

7. FORMS OF TEMPORAL CONTINUATION
---------------------------------

Do not hide these under one word such as "survival."
...
PART V — CLOSE-NEIGHBOUR TESTS
==============================

Use these when classification feels unstable.

DIFFERENTIATION vs RELATING
---------------------------
Differentiation:
Which is which? What differs?

Relating:
How does this bear on that?

OPENING vs EFFICACY
-------------------
Opening:
A possibility became available.

Efficacy:
What remains is primarily a capability or effect.

RELATING vs INTEGRATION
-----------------------
Relating:
A connection becomes clear.

Integration:
Several parts become organized enough as one whole.

REPAIR vs SETTLEMENT
--------------------
Repair:
The thing is made adequately right again.

Settlement:
The outstanding question receives an answer.

FOCAL vs DISTRIBUTED
--------------------
Focal:
One locus becomes decisive.

Distributed:
No single locus suffices.

FOCAL/DISTRIBUTED vs RELEASE
----------------------------
Focal/Distributed:
Positive sufficiency is carried by one or several loci.

Release:
The completion consists in an old demand, governor, constraint, or concern losing its claim.

STANDING vs BEARING
-------------------
Standing:
What remains is primarily established as so.

Bearing:
What remains is primarily the relation itself.

BEARING vs EFFICACY
-------------------
Bearing:
I know how things stand together.

Efficacy:
What remains shows itself chiefly in what can now happen.

PART VI — UNCERTAINTY, TRUTH, AND ENOUGHNESS
============================================

1. MAKING SENSE IS NOT BEING RIGHT
----------------------------------

A person can genuinely make sense of something and still be wrong.

The thermostat case is canonical.

A completion is classified by how intelligibility became enough at the time.
Truth is a further question.

2. UNDERSTANDING UNCERTAINTY IS NOT REMOVING UNCERTAINTY
---------------------------------------------------------

A completion can preserve uncertainty.

Chapter 16:
the shop opening date becomes established while "first day?" remains open.

Chapter 25:
the alternatives become more exactly related without one interpretation winning.

Chapter 27:
Ruth's relation to the ticket and her mother's habit becomes richer without grief becoming resolved.

Therefore:

structured uncertainty can itself be a successful landing.

What changes may be:

- the alternatives become differentiated;
- their evidential bearings become clearer;
- the scope of what is and is not established becomes organized.

3. ENOUGH IS INDEXED
--------------------

Always silently supply:

Enough for what?
Enough at what scale?
Enough under which legitimate demand?
...
4. RELEASE CAN PRESERVE THE OBJECT
----------------------------------

In Release, the old thing may remain.

What changes is its authority.

A worry can remain remembered but cease governing action.
A rule can remain written but lose its claim.
A question can remain historically interesting after ceasing to control the next move.

The old thing may remain.
Its authority does not.

PART VII — THE SPIRAL AS COMPOSITION
====================================

The visible book repeatedly shows a larger movement:

something is live
-> something changes
-> the change becomes enough at some scale
-> something remains
-> that remainder enters what happens next
-> another person or later self may take it up
-> reality may resist
-> the matter may continue, transform, reopen, or become part of a larger matter.

This larger movement is not itself one of the 54.

It is how 54-type events compose through time.

A useful technical notation for authorship is:

M0 -> C1 -> R1 -> U1 -> M1 -> C2 -> R2 ...

Where:

M = live matter
C = local completion-event
R = immediate remainder
U = later uptake.

Same-matter continuity may or may not hold between M0 and M1.

Another person may enter at U1.

Correction may turn R1 into part of M1.

A larger completion can contain several smaller completions as components.

This is the architecture beneath the spiral form.

PART VIII — AUTHORING DISCIPLINE
================================

Before drafting a chapter, identify privately:

1. What is the live matter?
2. At what scale?
3. What local completion or completions occur?
4. Which 54 coordinates best diagnose those landings?
5. What remains immediately after each?
6. What later uptake occurs?
7. Does another person participate?
8. What could correct the understanding?
9. Does the same matter continue later, or only a similar matter?
10. What must remain open?

Do not make the chapter display this checklist.

The technical map should sharpen the writing, not leak into it.

If a chapter seems to fit many cells at once:
split the local events before changing the theory.

If one local landing still genuinely requires multiple values on one axis:
record it as a pressure case.

Do not force a false uniqueness.

APPENDIX A — THE 54 CANONICAL COORDINATE FORMS
==============================================

The following are compact glosses, not separate doctrines.

Each row fixes the transformation.
Each block varies completion topology and persistence mode.
...
APPENDIX B — CLASSIFICATION PROTOCOL
====================================

Use this protocol whenever a case feels ambiguous.

STEP 1 — NAME THE LIVE MATTER
Write one sentence beginning:

What was still live was...

Avoid naming the object alone.

Bad:
the drawer.

Better:
why the drawer stops before closing.

Better still, if classifying repair:
whether the drawer can be restored to reliable closing.

STEP 2 — FREEZE THE FRAME
Stop immediately before the landing.

Ask:

What had not yet become enough?

STEP 3 — IDENTIFY THE TRANSFORMATION
Choose the best first-coordinate answer.

If two seem to apply, ask whether one happened first and enabled the other.

STEP 4 — IDENTIFY THE SUFFICIENCY
What made this enough?

One decisive locus?
Several jointly?
Or did an old governor lose its claim?

STEP 5 — IDENTIFY THE IMMEDIATE REMAINDER
What remained right then?

Something established?
A relation?
A capability/effect?

Do not classify what happened hours, months, or chapters later.

STEP 6 — CHECK SCALE
Would the classification change if the live matter were larger or smaller?

If yes, record the scale.

STEP 7 — CHECK CLOSE NEIGHBOURS
Run the relevant tests in Part V.

STEP 8 — CHECK FOR COMPRESSION
If the event still seems to occupy several cells, split the episode into successive or nested landings.

STEP 9 — ONLY THEN RECORD A PRESSURE CASE
If irreducible ambiguity remains, preserve it.
Do not fake precision.

APPENDIX C — PROVISIONAL CROSSWALK, CHAPTERS 1–37
==================================================

These are diagnostic examples, not declarations that each chapter "is" one cell.

Each row identifies one representative local landing.

1. THE DRAWER THAT WOULDN'T CLOSE
Representative landing:
the drawer is restored to reliable closing after the split runner is understood and the fixing is moved.
Provisional form:
Repair x Distributed x Efficacy.
Why:
several observations and interventions jointly restore functioning.

2. ENOUGH
Representative landing:
the soup becomes ready to serve.
Provisional form:
Settlement x Distributed x Efficacy.
Why:
several sensory judgments together make the question "ready?" settled enough for serving.
Pressure:
later personal seasoning shows the scale of the question matters.

3. WHAT YOU GET TO KEEP
Representative landing:
which breaker controls the counter-wall sockets becomes established.
Provisional form:
Settlement x Focal x Standing.
Why:
one successful switch identifies the circuit well enough for the current matter.
Later:
that Standing becomes material for later Efficacy, but the later use does not rewrite the original remainder.

4. LOOK AGAIN
Representative landing:
the correct platform becomes established after repeated listening and the train's arrival.
Provisional form:
Settlement x Distributed x Standing.
Why:
announcement, display, and arrival converge.

5. THE SAME THING BETWEEN US
Representative landing:
the source of the hallway leak is connected to the copper joint.
Provisional form:
Relating x Focal x Bearing.
Why:
the exposed bead of water becomes the decisive relation.

6. WHEN THE ANSWER FIGHTS BACK
Representative landing:
the cycling boiler becomes intelligible through poor circulation rather than a bad thermostat.
Provisional form:
Relating x Distributed x Bearing.
Why:
radiator pattern, pump heat, filter condition, and system behaviour jointly reorganize the explanation.

7. WHAT KEEPS HAPPENING?
Representative landing:
unlike stories become visible as recurring forms under three questions.
Provisional form:
Integration x Distributed x Standing.
Why:
several episodes become one organized comparative pattern.

8. THERE
Representative landing:
the desk leg's shallow cut is understood through how it clears the bracket.
Provisional form:
Relating x Focal x Bearing.
Why:
one feature becomes decisive for the relation between leg and bracket.

9. STILL ABOUT THAT
Representative landing:
Ben's later actions are understood as counting toward or against the earlier promise.
Provisional form:
Relating x Distributed x Bearing.
Why:
wording, timing, expectation, and action jointly sustain the undertaking's bearing.

10. WHAT YESTERDAY STILL WANTS
Representative landing:
the old tap warning makes the earlier unfinished matter available to a later person.
Provisional form:
Opening x Focal x Efficacy.
Why:
one record opens a practical next move.
Important:
the note is a carrier, not identical to the understanding.

11. STILL THE SAME?
Representative landing:
the distinction between continuation and mere resemblance becomes explicit.
Provisional form:
Differentiation x Distributed x Bearing.
Why:
several cases clarify how later events can still answer earlier matters.

12. THE HALF-FINISHED THING
Representative landing:
the rising floor is identified as what makes the window-seat box jam.
Provisional form:
Relating x Focal x Standing.
Why:
one measurement becomes decisive.
Later:
trimming the box is a separate Repair x Focal/Distributed x Efficacy event.

13. FOR WHOEVER COMES NEXT
Representative landing:
bread readiness becomes available through look, touch, resistance, and sound together.
Provisional form:
Integration x Distributed x Efficacy.
Why:
several cues become one usable practice.

14. THE PATTERN TRAVELS
Representative landing:
the three questions are recognized as cross-cutting several domains.
Provisional form:
Integration x Distributed x Standing.
Why:
multiple cases become one organized comparative map.

15. THE RULE YOU DIDN'T DISCOVER
Representative landing:
Amira understands why the sevens increase by seven through another group of seven.
Provisional form:
Relating x Focal x Bearing.
Why:
one organizing relation connects the inherited rule to repeated addition.

16. A QUESTION OLDER THAN YOU
Representative landing:
shop opening date is separated from the still-unsettled question of whether the photo shows the first day.
Provisional form:
Differentiation x Focal x Standing.
Why:
the advertisement establishes one date while preserving the larger uncertainty.

17. EVERYONE KNEW
Representative landing:
the shared fuse explanation loses its claim when the kettle fails under the predicted corrective test.
Provisional form:
Settlement x Release x Standing.
Why:
the old answer stops governing and the fault is localized differently.
Pressure:
the exact transformation could be split into Release followed by a new Settlement.

18. WHAT DID WE INHERIT?
Representative landing:
answer, question, and mistake become distinct kinds of inheritance.
Provisional form:
Differentiation x Distributed x Standing.

19. ODD, EVEN, THEN WHAT?
Representative landing:
odd plus odd becomes intelligible through the two leftovers forming a pair.
Provisional form:
Relating x Focal x Bearing.
Why:
one structural relation explains the pattern.
Counterexample "2" later produces a separate Differentiation/Repair event for the prime-number claim.

20. YOU CAN LEAVE
Representative landing:
physical ability is separated from what an action counts as under a promise or rule.
Provisional form:
Differentiation x Focal x Bearing.
Why:
the distinction leaves a relation between action and norm available.

21. YOU KNOW THIS PART
Representative landing:
Mara hears her violin figure as continuing the cello line and sitting under the clarinet entrance.
Provisional form:
Relating x Distributed x Bearing.
Why:
several musical lines jointly make the phrase intelligible.
Important:
there was no sharply felt prior "problem." The live matter can be a not-yet-heard organization rather than an explicit question.

22. YOU HAD TO BE THERE
Representative landing:
Mateo gets the joke when a later situation instantiates the same mismatch.
Provisional form:
Relating x Distributed x Bearing.
Why:
tone, context, prior episode, and present mismatch jointly make the relation land.
Pressure:
response and explanation remain distinct.

23. DON'T TELL ME HOW
Representative landing:
Sami acquires a stable enough cycling pattern to continue independently.
Provisional form:
Integration x Distributed x Efficacy.
Why:
balance, movement, visual attention, steering, and bodily adjustment become one practical coordination.
Important:
verbal explanation is neither necessary nor sufficient.

24. SAME DIRECTION
Representative landing:
Eli and Sana discover that successful coordination had rested on different cues.
Provisional form:
Differentiation x Focal x Standing.
Why:
the changed performance cue exposes the hidden difference.
Later:
their wrist-tap convention is a separate Integration x Focal x Efficacy event.

25. DON'T DECIDE YET
Representative landing:
the reading group distinguishes several live interpretations and exactly what supports each without selecting one winner.
Provisional form:
Differentiation x Distributed x Bearing.
Why:
several textual details structure the alternatives relationally.
Important:
the successful landing preserves plurality.

26. NOT TO SCALE
Representative landing:
Tomas understands that the metro diagram preserves network order and interchange rather than geographic distance.
Provisional form:
Relating x Distributed x Bearing.
Alternative live matter:
if the question is whether he can now use the map to navigate the network, the later landing may be Opening x Distributed x Efficacy.
This is a canonical scale/question demonstration.

27. NOTHING TO FIX
Representative landing:
Ruth sees her mother's saved scraps partly as ways back into places, names, and questions while retaining irritation and grief.
Provisional form:
Relating x Distributed x Bearing.
Important:
the larger matter of grief remains open.
This chapter demonstrates local completion inside global non-resolution.

28. SAY IT ANOTHER WAY
Representative landing:
Elena and her father recognize fidelity as preserving a pattern of significance across changed wording rather than literal verbal identity.
Provisional form:
Relating x Distributed x Bearing.
Pressure:
same-matter continuity across translation remains genuinely open at the edges.

29. CLOSE ENOUGH TO PREDICT
Representative landing:
the small-angle approximation becomes understood as trustworthy within a range rather than simply true or false.
Provisional form:
Differentiation x Distributed x Bearing.
Why:
model, measurement, range, and purpose jointly establish where the shortcut bears correctly.
Alternative:
the boundary itself may yield Standing if the live matter is "where does this approximation cease to suffice?"

30. ORIGINAL
Representative landing:
the staircase becomes intelligible as one continuing object made of materials from different times.
Provisional form:
Integration x Distributed x Bearing.
Why:
identity is carried through an organized history of retained, replaced, and repaired parts.
Pressure:
same-object continuity is not reduced to unchanged material.

31. THAT'S NOT HOW IT HAPPENED
Representative landing:
the video establishes some facts while separating them from disputed motive and remembered experience.
Provisional form:
Differentiation x Distributed x Standing.
Why:
recording, memory, and later testimony jointly narrow what is established.
Important:
uncertainty is reduced in one dimension and preserved in another.

32. IT STILL LOOKS WRONG
Representative landing:
Ravi and Mae come to see the jug-handle judgment through proportion, use, context, and relation to the whole.
Provisional form:
Relating x Distributed x Bearing.
Important:
aesthetic disagreement can become better organized without a single settling measurement.

33. WE AGREE ON WHAT HAPPENED
Representative landing:
Priya's proposal for a second lead opens a course of action that reduces risk without dissolving the conflict of responsibilities.
Provisional form:
Opening x Distributed x Efficacy.
Why:
the new move becomes possible because several responsibilities and constraints are held together.
Important:
better action does not imply the moral question was fully settled.

34. THE OLD RULE
Representative landing:
the club arrives at a revised sign-out practice combining live system, visible tags, and paper fallback.
Provisional form:
Integration x Distributed x Efficacy.
Why:
several mechanisms are organized into one workable safety practice.
Separate possible Release event:
the old whiteboard ceases to be the sole governor of compliance.

35. NO ONE KNOWS THE WHOLE THING
Representative landing:
the exhibition becomes coherent through distributed specialist knowledge that no one person possesses in full.
Provisional form:
Integration x Distributed x Efficacy.
Why:
many partial contributions jointly produce a functioning whole.
Important:
distributed completion does not require a shared mind.

36. SHE WOULDN'T DO THAT
Representative landing:
Mara's final departure becomes intelligible in relation to earlier scenes once Lia restores a history that can bear on it.
Provisional form:
Relating x Distributed x Bearing.
Pressure:
revision versus replacement remains open.

37. THE DRAWER COMES OUT
Representative landing:
Nora's inherited "lift it and watch" move fails, immediately showing that the new drawer is not failing in the old way and redirecting inquiry.
Provisional form:
Differentiation x Release x Efficacy.
Why:
the old diagnosis loses governing force through the failed test, and the failure itself opens a useful next move.
Later:
the spatula obstruction yields a separate Settlement/Repair event.

APPENDIX D — REPRESENTATIVE MULTI-EVENT ANALYSIS
================================================

A single chapter often contains a chain.

Example: Chapter 1.

Possible sequence:

1. Utensil obstruction hypothesis fails.
   Local event:
   old candidate explanation loses force.
   Possible form:
   Differentiation or Settlement x Release x Standing.

2. Left side dropping is noticed.
   Local event:
   difference in drawer movement becomes salient.
   Possible form:
   Differentiation x Focal x Standing.

3. Loose runner is identified.
   Local event:
   relation between movement and hardware becomes clear.
   Possible form:
   Relating x Focal x Bearing.

4. Screw tightening produces temporary function.
   Local event:
   drawer closes.
   Possible form:
   Repair x Focal x Efficacy.

5. Failure returns and split wood is exposed.
   Local event:
   first repair is reopened and mechanism is corrected.
   Possible form:
   Relating x Focal x Bearing.

6. Glue + moved fixing + test under load restore reliable use.
   Local event:
   repaired system becomes adequate.
   Possible form:
   Repair x Distributed x Efficacy.

This is why "the drawer chapter fits several cells" is not a refutation.

The chapter contains several landings.

APPENDIX E — PRESSURE TESTS THE SYSTEM MUST SURVIVE
===================================================

1. NO EXPLICIT PRIOR QUESTION
Can recognition count as a completion when no one experienced a problem beforehand?

Current answer:
possibly yes, if the live matter is a not-yet-available organization rather than a consciously formulated question.

Do not solve this by redefining all experience as "unresolved."
Keep pressure on the distinction.

2. PLURALITY PRESERVED
Can a completion leave several interpretations live?

Current answer:
yes.
Differentiation, Relating, or Integration may structure uncertainty without Settlement selecting one answer.

3. TACIT SKILL
Can Efficacy persist where Standing and Bearing are weakly articulable?

Chapter 23 says yes.

Do not infer that skill lacks structure merely because the person cannot state it.

4. COORDINATION WITHOUT MUTUAL UNDERSTANDING
Can people succeed together while misunderstanding why coordination works?

Chapter 24 says yes.

Therefore:
joint efficacy is not by itself proof of shared Bearing.

5. AESTHETIC JUDGMENT
Can disagreement become more exact without becoming settled?

Chapter 32 says yes.

The system must allow improved intelligibility without forcing Settlement.

6. MORAL CONFLICT
Can two responsibilities remain genuinely live after the situation is understood more clearly?

Chapter 33 says yes.

Do not confuse greater understanding with removal of conflict.

7. FICTION
Can something be constrained without an external physical object pushing back?

Chapter 36 says yes.

Earlier characterization, reader uptake, internal coherence, genre, and revision can all constrain later sense-making.
Do not literalize "reality pushes back" so narrowly that fiction becomes impossible.

8. SAME-MATTER BORDERLINES
Translation, restoration, rules, memories, models, and fictional characters all produce borderline continuity cases.

Do not force one universal criterion too early.

APPENDIX F — CURRENT OPEN TECHNICAL QUESTIONS
=============================================

These should remain live.

1. Are the six transformation patterns jointly exhaustive?

2. Are all six genuinely irreducible at the chosen local scale?

3. Is Release best kept as a completion topology alongside Focal and Distributed, or should future cases force a refinement of how trigger-distribution and discharge relate?

Current working answer:
keep Release, but distinguish trigger structure from form of sufficiency.

4. Can one local achievement have genuinely co-primary persistence modes?

Current working discipline:
first split compressed events.
If irreducible co-primary cases remain, preserve them as pressure cases rather than weakening the categories by fiat.

5. Does Settlement describe a basic transformation or a higher-order ending that can accompany others?

Current discipline:
use Settlement only when receiving an answer is itself the live transformation.
Do not label every completed event Settlement.

6. How much continuity is required for same-matter identity across people and time?

Still open.

7. When does revised understanding become replacement?

Still open.

8. How should non-propositional understanding be represented without reducing it to Efficacy alone?

Chapters 21, 22, 23, 27, and 32 are especially important.

9. How does a local completion become publicly available without becoming frozen?

Still central.

10. How do many local completions compose into institutions, practices, sciences, languages, and inherited worlds?

This is the larger horizon.

APPENDIX G — WRITING RULES FOR FUTURE CHAPTERS
===============================================

1. Do not write a chapter to fill an empty cell.

2. Do not make characters perform the theory.

3. Do not announce the coordinates in visible prose unless the story has earned explicit reflection.

4. Let difficult cases damage the map if they must.

5. When a chapter appears to contradict the system, classify local landings before revising the whole architecture.

6. Preserve distinctions:
- making sense vs being right;
- uncertainty structured vs uncertainty removed;
- immediate remainder vs later uptake;
- carrier vs understanding;
- physical possibility vs normative count;
- agreement vs shared matter;
- answer inherited vs question inherited;
- revision vs replacement;
- record surviving vs understanding surviving.

7. Let earlier scenes return only when their significance changes.

8. Keep the spiral:
a local matter,
a change,
enoughness at some scale,
a remainder,
later uptake,
...
9. Do not require every chapter to end in comfort.

10. The book is allowed to discover its own length.

FINAL AUTHORING REMINDER
========================

The 54 are not the whole theory.

They describe the local form of a completion-event.

The larger inquiry concerns how those events:
...
- are communicated;
- are corrected;
- remain answerable to earlier matters;
- become parts of later understanding;
- and accumulate into realities that people can inhabit together without those realities becoming immune to revision.

The central technical discipline is therefore:

Freeze the live matter.
Choose the scale.
Classify the landing.
Separate the immediate remainder from its later use.
